...
const copies = [
  ...
  [
    resolve(repo, "data/marriage-license/maintenance.sample.json"),
    resolve(web, "src/data/marriageLicenseMaintenance.json"),
  ],
  [
    resolve(repo, "data/scale/grid.sample.json"),
    resolve(web, "src/data/scaleGrid.json"),
  ],
];
